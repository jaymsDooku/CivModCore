package vg.civcraft.mc.civmodcore.ui;
...
public class UIManager {
    ...
    public UI getScoreboard(Player player, String title) {
        ...
        if (board == null) {
        	...
        	CivModCorePlugin.getInstance().getLogger().info("Instantiated new scoreboard UI for " + player.getName());
        }
    ...
    public void start() {
    	...
    	updateTask = Bukkit.getScheduler().runTaskTimer(CivModCorePlugin.getInstance(), new Runnable() {
